        ...
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            
            {
                var p1 = new Prognosis
                {
                    ...
                    {
                         new BudgetPost { Amount = 28500, CategoryId = 14, Description = "Lön", Recurring = Recurring.Monthly, Date = new DateTime(now.Year, now.Month, 23), PostType = BudgetPostType.Income, RecurringId = new Guid("389904d6-c94c-4bd8-8864-27644219f5ad") },
                ...
                var p2 = new Prognosis
                {
                    ...
                    BudgetPosts = new List<BudgetPost>
                    {
                        new BudgetPost { Amount = 28500, CategoryId = 14, Description = "Lön", Recurring = Recurring.Monthly, Date = new DateTime(now.AddMonths(-1).Year, now.AddMonths(-1).Month, 23), PostType = BudgetPostType.Income, RecurringId = new Guid("389904d6-c94c-4bd8-8864-27644219f5ad") },
                ...
                {
                    // RECURRING
                      new BudgetPost { Amount = 28500, CategoryId = 14, Description = "Lön", Recurring = Recurring.Monthly, Date = new DateTime(now.AddMonths(-2).Year, now.AddMonths(-2).Month, 23), PostType = BudgetPostType.Income, RecurringId = new Guid("389904d6-c94c-4bd8-8864-27644219f5ad") },
                ...
                {
                    // RECURRING
                    new BudgetPost { Amount = 28500, CategoryId = 14, Description = "Lön", Recurring = Recurring.Monthly, Date = new DateTime(now.AddMonths(-3).Year, now.AddMonths(-3).Month, 23), PostType = BudgetPostType.Income, RecurringId = new Guid("389904d6-c94c-4bd8-8864-27644219f5ad") },
                ...
                {
                    // RECURRING …
                     new BudgetPost { Amount = 28500, CategoryId = 14, Description = "Lön", Recurring = Recurring.Monthly, Date = new DateTime(now.AddMonths(-4).Year, now.AddMonths(-4).Month, 23), PostType = BudgetPostType.Income, RecurringId = new Guid("389904d6-c94c-4bd8-8864-27644219f5ad") },
                ...
                {
                    // RECURRING
                    new BudgetPost { Amount = 28500, CategoryId = 14, Description = "Lön", Recurring = Recurring.Monthly, Date = new DateTime(now.AddMonths(-5).Year, now.AddMonths(-5).Month, 23), PostType = BudgetPostType.Income, RecurringId = new Guid("389904d6-c94c-4bd8-8864-27644219f5ad") },
